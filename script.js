...
let goals = [];
let chart;
let limit = 0; // Spending limit
let streakCount = 0;
let lastSavedDate = null; // Tracks last date a saving was added
...
async function deleteGoalFirestore(goalId) {
...
async function deleteExpenseFirestore(expenseId) {
